...
class Cart extends Model{
	...
	public function getProducts(){
		...
		$rows = $sql->select("
			...
			GROUP BY b.idproduct,b.desproduct, b.vlprice,b.vlwidth,b.vlheight,b.vllength, b.vlweight
	...
	public function getProductsTotals(){
		...
		$results = $sql->select("
			SELECT SUM(vlprice) AS vlprice, MAX(vlwidth) AS vlwidth, MAX(vlheight) as vlheight, SUM(vllength) as vllength, SUM(vlweight) AS vlweight, COUNT(*) AS nrqtd
			FROM tb_products a
	...
	//		echo "http://ws.correios.com.br/calculador/CalcPrecoPrazo.asmx/CalcPrecoPrazo?".$qs;
