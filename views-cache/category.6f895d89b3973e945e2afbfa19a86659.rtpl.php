            ...
            <div class="col-md-12">
                <div class="product-pagination text-center">
                    <nav>
                        <ul class="pagination">
                        <li>
                            <a href="/categories/<?php echo htmlspecialchars( $category["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>?page=<?php echo htmlspecialchars( $page["num"]-1, ENT_COMPAT, 'UTF-8', FALSE ); ?>" aria-label="Previous"> 
                        ...
                        <li>
                            <a href="/categories/<?php echo htmlspecialchars( $category["idcategory"], ENT_COMPAT, 'UTF-8', FALSE ); ?>?page=<?php echo htmlspecialchars( $page["num"]+1, ENT_COMPAT, 'UTF-8', FALSE ); ?>" aria-label="Next"> 
                                <span aria-hidden="true" style="hover"> >> </span> 
                            </a>
                        </li>
                        </ul>
