          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="box box-widget">
                <div class="box-body">
                  <img class="img-responsive" id="image-preview" src="<?php echo htmlspecialchars( $product["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="Photo" style="height: 350px width: 300px">
                </div>
              </div>
            </div>
          </div>
